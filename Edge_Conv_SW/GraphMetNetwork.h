...
// @updated (Tu Pham): Update scaling for input
// @date: 11/16/2024
//===========================================================================
...
class GraphMetNetwork {
    ...
    private:
        ...
        /** normalization */
        int scale_momentum = 128;
        float norm[CONT_DIM] = {1.0f / scale_momentum, 1.0f / scale_momentum, 1.0f / scale_momentum, 1.0, 1.0, 1.0};
        ...
        */
        ...
        // sigmoid activation
        void apply_sigmoid(float arr[], int length);
